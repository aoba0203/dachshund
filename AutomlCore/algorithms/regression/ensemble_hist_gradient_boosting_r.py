...
from sklearn.ensemble import HistGradientBoostingRegressor as HistGradientBoosting
from hyperopt import hp
from utils import definitions
from .. import model, model_regression

class HistGradientBoostingRegressor(model.Model, model_regression.ModelRegression):
